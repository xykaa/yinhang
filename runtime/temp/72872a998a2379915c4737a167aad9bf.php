<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"C:\Users\Carry\Desktop\yinhang/application/admin\view\widget\images.php";i:1577156538;}*/ ?>
<!DOCTYPE html>
...
<script>
    var pid = <?php echo $pid; ?>,small = <?php echo \think\Request::instance()->param('small')?: 0; ?> ,parentinputname = '<?php echo \think\Request::instance()->param('fodder'); ?>';//当前图片分类ID
