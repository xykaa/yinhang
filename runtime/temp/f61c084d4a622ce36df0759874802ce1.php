<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:75:"C:\wamp64\www\we\yinhang/application/admin\view\shangjia\activity\index.php";i:1577434498;s:68:"C:\wamp64\www\we\yinhang\application\admin\view\public\container.php";i:1577441269;s:69:"C:\wamp64\www\we\yinhang\application\admin\view\public\frame_head.php";i:1577441269;s:64:"C:\wamp64\www\we\yinhang\application\admin\view\public\style.php";i:1577441269;s:69:"C:\wamp64\www\we\yinhang\application\admin\view\public\inner_page.php";i:1577441269;s:71:"C:\wamp64\www\we\yinhang\application\admin\view\public\frame_footer.php";i:1577441269;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                    ...
                    <div class="m-b m-l">
                        ...
                        <form action="" class="form-inline">
                            ...
                            <select name="status" aria-controls="editable" class="form-control input-sm">
                                ...
                                <option value="1" <?php if($where['status'] == '1'): ?>selected="selected"<?php endif; ?>>开始</option>
                                <option value="2" <?php if($where['status'] == '2'): ?>selected="selected"<?php endif; ?>>已结束</option>
                                <option value="3" <?php if($where['status'] == '3'): ?>selected="selected"<?php endif; ?>>未开始</option>
                            </select>
                            <div class="input-group" style="margin-top: 5px">
                                <input type="text" placeholder="请输入商家名或者活动名" class="input-sm form-control" name="title" value="<?php echo $where['title']; ?>">
