<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:75:"C:\wamp64\www\we\yinhang/application/admin\view\shangjia\shoplist\index.php";i:1577434498;s:68:"C:\wamp64\www\we\yinhang\application\admin\view\public\container.php";i:1577441269;s:69:"C:\wamp64\www\we\yinhang\application\admin\view\public\frame_head.php";i:1577441269;s:64:"C:\wamp64\www\we\yinhang\application\admin\view\public\style.php";i:1577441269;s:71:"C:\wamp64\www\we\yinhang\application\admin\view\public\frame_footer.php";i:1577441269;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="level_id" lay-verify="level_id">
                                    <option value="">全部</option>
                                    <?php if(is_array($level_list) || $level_list instanceof \think\Collection || $level_list instanceof \think\Paginator): $i = 0; $__LIST__ = $level_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
...
<script>
    ...
    layList.tableList('userList',"<?php echo Url('get_user_list'); ?>",function () {
        return [
            ...
            {field: 'name', title: '门店名称', event:'open_image', width: '8%'},
            ...
            {fixed: 'right', title: '操作', width: '13.5%', align: 'center', toolbar: '#barDemo'}
        ];
    });
    ...
    layList.tool(function (event,data,obj) {
        ...
        switch (layEvent){
            ...
            case 'del_level':
                ...
                break;
            case 'give_level':
                $eb.createModalFrame(data.name+'-赠送会员',layList.Url({a:'give_level',p:{uid:data.uid}}),{w:500,h:200});
                break;
            case 'money':
                $eb.createModalFrame(data.name+'-积分余额修改',layList.Url({a:'edit_other',p:{uid:data.uid}}));
                break;
            case 'open_image':
