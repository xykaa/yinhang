                        ...
                        <form action="" class="form-inline search-form">
                                <div class="search-item" data-name="date">
                                    ...
                                    <div class="datepicker" style="display: inline-block;">
                                        <button type="button" class="btn btn-outline btn-link" data-value="<?php echo !empty($where['date'])?$where['date']:'no'; ?>">自定义</button>
                                    </div>
                                    <input class="search-item-value" type="hidden" name="date" value="<?php echo $where['date']; ?>" />
                                </div>
                                ...
                                <div class="search-item search-item-css" data-name="is_promoter">
                                    ...
                                    <input class="search-item-value" type="hidden" name="is_promoter" value="<?php echo $where['is_promoter']; ?>" />
                                </div>
            ...
            <div class="ibox-title">
                ...
                <div class="ibox-content"  style="height: 115px">
                    <div class="col-sm-6" style="border-right: 1px solid #CCCCCC">
                        <p style="font-size: 12px"><?php echo $consume['rightTitle']['title']; ?></p>
                        <p style="font-size: 16px;color:#ed5565"><i class="fa <?php echo $consume['rightTitle']['icon']; ?>" style="padding-right: 10px;"></i>&nbsp;&nbsp;￥<?php echo $consume['rightTitle']['number']; ?></p>
                    </div>
                    <div class="col-sm-6">
                        <p style="font-size: 12px"><?php echo $consume['leftTitle']['title']; ?></p>
                        <p style="font-size: 16px;color:#23c6c8;"><i class="fa <?php echo $consume['leftTitle']['icon']; ?>" style="padding-right: 10px;">&nbsp;&nbsp;<?php echo $consume['leftTitle']['count']; ?></i></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="ibox-content" style="height:290px;overflow-y: scroll;background-color: #ffffff">
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo $vo['totel_number']; ?></td>
